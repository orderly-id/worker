...
A Worker Definition can be used to create multiple Worker Instances.
...
Multiple instances created from the same Worker Definition MUST NOT automatically share private instance data.
...
The suffix SHOULD be generated by Orderly.

The suffix SHOULD use characters that are reasonably easy for humans to distinguish.
...
```text
/api/workers/@harian.a45fc/notes
```
...
Deleting or disabling one instance MUST NOT affect unrelated instances of the same Worker.
